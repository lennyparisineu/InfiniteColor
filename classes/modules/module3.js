const MODULE_3 = new Module([
  ...
  new Block(BLOCK_SIZE * 4, canvas.clientHeight / 2 + BLOCK_SIZE, COLOR.BLUE),
  new Block(BLOCK_SIZE * 4, canvas.clientHeight / 2, COLOR.BLUE),
  new Block(BLOCK_SIZE * 5, canvas.clientHeight / 2 + BLOCK_SIZE),
  new Block(BLOCK_SIZE * 6, canvas.clientHeight / 2 + BLOCK_SIZE),
  new Block(BLOCK_SIZE * 7, canvas.clientHeight / 2 + BLOCK_SIZE, COLOR.RED),
  new Block(BLOCK_SIZE * 7, canvas.clientHeight / 2, COLOR.RED),
  new Block(BLOCK_SIZE * 8, canvas.clientHeight / 2 + BLOCK_SIZE),
  new Block(BLOCK_SIZE * 9, canvas.clientHeight / 2 + BLOCK_SIZE),
  new Block(BLOCK_SIZE * 10, canvas.clientHeight / 2 + BLOCK_SIZE, COLOR.GREEN),
  new Block(BLOCK_SIZE * 10, canvas.clientHeight / 2, COLOR.GREEN),
  new Block(BLOCK_SIZE * 11, canvas.clientHeight / 2 + BLOCK_SIZE),
  new Block(BLOCK_SIZE * 12, canvas.clientHeight / 2 + BLOCK_SIZE),
  new Block(BLOCK_SIZE * 13, canvas.clientHeight / 2 + BLOCK_SIZE, COLOR.RED),
  new Block(BLOCK_SIZE * 13, canvas.clientHeight / 2, COLOR.RED),
  new Block(BLOCK_SIZE * 14, canvas.clientHeight / 2 + BLOCK_SIZE),
  new Block(BLOCK_SIZE * 15, canvas.clientHeight / 2 + BLOCK_SIZE),
  new Block(BLOCK_SIZE * 16, canvas.clientHeight / 2 + BLOCK_SIZE, COLOR.GREEN),
  new Block(BLOCK_SIZE * 16, canvas.clientHeight / 2, COLOR.GREEN),
